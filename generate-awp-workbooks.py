...
# ── Scoping Sheet ───────────────────────────────────────────────────
def add_scoping_sheet(wb, engagement_name):
...
def build_workbook(engagement_name, regulatory_basis, scope_desc,
    ...
    add_scoping_sheet(wb, engagement_name)
...
if __name__ == '__main__':
    ...
    create_nra_workbook()
    print('\nAll 5 IESP AWP workbooks generated (v2).')
